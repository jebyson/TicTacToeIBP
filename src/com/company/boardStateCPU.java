...
public class boardStateCPU {
    ...
    static void printBoard() {
        for (int i = 0; i < boardStateCPU.board.length; i++) {
            for (int j = 0; j < boardStateCPU.board.length; j++)
                System.out.print(boardStateCPU.board[i][j]);
            System.out.println();
        }
    }
